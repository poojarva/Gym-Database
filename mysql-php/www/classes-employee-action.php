...
class Classes
{
    public function listClasses()
    {
        ...
        while ($sqlRow = $stmt->fetch()) {
            ...
            $dataRow[] = '<button type="button" name="update" emp_id="' . $sqlRow["Class_Id"] . '" class="btn btn-warning btn-sm update">Update Class</button>
                          <button type="button" name="delete" emp_id="' . $sqlRow["Class_Id"] . '" class="btn btn-danger btn-sm delete" >Delete Class</button>';
