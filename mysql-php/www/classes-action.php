...
class Classes
{
    public function listClasses()
    {
        ...
        while ($sqlRow = $stmt->fetch()) {
            ...
            $dataRow[] = $sqlRow['Class_Limit'];
            $dataRow[] = $sqlRow['Class_Max'];
