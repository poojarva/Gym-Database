...
class Classes
{
    public function listClasses()
    {
        ...
        $sqlQuery = "SELECT c.class_id as 'Class_Id', c.class_length as 'Class_Length', c.limit_capacity as 'Limit', c.class_name 'Class_Name', u.first_name 'Instructor_First_Name', u.last_name as 'Instructor_Last_Name' FROM classes c JOIN instructor_classes ic USING (class_id) JOIN employees e USING (employee_id) JOIN users u USING (username_id);";
